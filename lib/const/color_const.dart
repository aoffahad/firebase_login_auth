...
const defaultColor = Color(0xff3C8DBC);
const drawerColor = Color(0xff367FA9);
const selectedDrawerRowColor = Color(0xff1E475E);

class ColorConstant {
  static Color primaryColor = fromHex('#2196F3');
  static const Color secondary = Colors.black;
  static const Color submitButtonColor = Color(0xff3C8DBC);
  ...
  static const Color buttonColor = Color(0xff367FA9);
